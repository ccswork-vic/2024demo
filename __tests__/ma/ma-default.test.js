...
describe('檢查上方目錄', () => {
  test('檢查ma方目錄登入名稱', async () => {
    ...
    assert.equal(loginnameText, 'VICMA', 'loginname Text is incorrect');

  });
  test('檢查ma上方目錄金額區塊', async () => {
