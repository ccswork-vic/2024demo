...
exports.SeleniumAdminInstance = void 0;
var selenium_webdriver_1 = require("selenium-webdriver");
var chrome = require("selenium-webdriver/chrome");
var SeleniumAdminInstance = /** @class */ (function () {
    function SeleniumAdminInstance() {
        this.isInGame = false;
    }
    SeleniumAdminInstance.prototype.buildDriver = function () {
    ...
    SeleniumAdminInstance.prototype.getJdb = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SeleniumAdminInstance.prototype.login = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SeleniumAdminInstance.prototype.verifyName = function () {
        return __awaiter(this, void 0, void 0, function () {
            var loginNameElement, loginName, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, 5, , 6]);
                        return [4 /*yield*/, this.driver.wait(selenium_webdriver_1.until.elementLocated(selenium_webdriver_1.By.xpath('//*[@id="root"]/div/div/header/div[2]/div[1]/button/span[2]')), 5000)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.driver.findElement(selenium_webdriver_1.By.xpath('//*[@id="root"]/div/div/header/div[2]/div[1]/button/span[2]'))];
                    case 3:
                        loginNameElement = _a.sent();
                        return [4 /*yield*/, loginNameElement.getText()];
                    case 4:
                        loginName = _a.sent();
    ...
    SeleniumAdminInstance.prototype.quit = function () {
        if (this.driver && this.driver.quit)
            this.driver.quit();
    };
    return SeleniumAdminInstance;
}());
exports.SeleniumAdminInstance = SeleniumAdminInstance;
function sleep(ms) {
