...
var SeleniumWorker_1 = require("./selenium/SeleniumWorker");
var ExpressServer_1 = require("./express/ExpressServer");
var ActionType_1 = require("./vo/ActionType");
var Main = /** @class */ (function () {
    function Main() {
        this.seleniumWorker = new SeleniumWorker_1.SeleniumWorker();
        this.expressServer = new ExpressServer_1.ExpressServer();
    ...
    Main.prototype.onClientMessage = function (msg) {
        return __awaiter(this, void 0, void 0, function () {
            var message, login, startGame, spin;
            return __generator(this, function (_a) {
                message = JSON.parse(msg);
                console.log(message.type);
                switch (message.type) {
                    case ActionType_1.ActionType.Login:
                        login = message.data;
                        ...
                        break;
                    case ActionType_1.ActionType.StartGame:
                        startGame = message.data;
                        console.log('StartGame:', message.data);
                        break;
                    case ActionType_1.ActionType.Spin:
                        spin = message.data;
    ...
    Main.prototype.onDisconnect = function () {
